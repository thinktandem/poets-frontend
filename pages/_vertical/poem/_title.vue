          ...
          >
            ...
            <div slot="header">
              ...
              >
                ...
                <span v-if="poet.field_dob !== null">- {{ poet.field_dob.split("-", 1)[0] }} - {{ poet.field_dod }}</span>
              </span>
            </div>
            <poem-actions
...
.card--main {
  ...
  .card--poem__attribution {
    <<<<<<<headfont-family: $font-family-serif-italic;
    =======>>>>>>>3991c155320948956080529ed3fb49e695499533
    font-size: 0.8rem;
    line-height: 1.25rem;
  }
}
