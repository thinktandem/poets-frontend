<template>
  <div>
    <b-container class="winner-list tabular-list">
      ...
      <b-row
        ...
        class="tabular-list__row winner-list__books"
        :key="programs.title"
      >
        <b-col
          class="date"
      ...
      <div class="pager">
        ...
        >
          ...
          >
            <a
              :href="`/poetsorg/winner?page=${Prev}${preparedCombine}`"
              class="page-link"
            >
          ...
          >
            <a
              ...
              :href="`/poetsorg/winner?page=${pageNum + 1}{preparedCombine}`"
              class="page-link"
            >
              {{ pageNum + 1 }}
            </a>
          ...
          >
            <a
              ...
              :href="`/poetsorg/winner?page=${pageNum + 2}${preparedCombine}`"
              class="page-link"
            >
              {{ pageNum + 2 }}
            </a>
          ...
          >
            <a
              ...
              :href="`/poetsorg/winner?page=${pageNum + 3}${preparedCombine}`"
              class="page-link"
            >
              {{ pageNum + 3 }}
            </a>
          ...
          >
            <a
              v-if="pageNum + 1 < totalPages"
              :href="`/poetsorg/winner?page=${totalPages - 1}${preparedCombine}`"
              class="page-link"
            >
              {{ totalPages }}
            </a>
          ...
          >
            <a
              :href="`/poetsorg/winner?page=${Next}${preparedCombine}`"
              class="page-link"
              :class="{disabled: !Next}"
            >
              Next
